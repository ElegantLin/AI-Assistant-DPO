    ...
    def concatenated_inputs(
        ...
        if is_vision_model:
            concatenated_batch["pixel_values"] = (
                batch["prompt_pixel_values"].repeat(2, 1, 1, 1, 1).to(device=device)
            )
